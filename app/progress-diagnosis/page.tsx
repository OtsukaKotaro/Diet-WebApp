  ...
  export default function ProgressDiagnosisPage() {
    ...
    const handleDiagnosis = () => {
      ...
      try {
        ...
        const achievementDate = achievementDateObj
          .toISOString()
      ...
      <div style={containerStyle}>
        ...
        {result && (
          <div style={resultStyle}>
            ...
            <div>理想のペース: 1日あたり {result.idealDailyChange.toFixed(3)} kg</
  div>
            <div>現在のペース: 1日あたり {result.realDailyChange.toFixed(3)} kg</
  div>
            <div>達成予定日: {result.achievementDate} 日</div>
            <div>
              目標達成に必要なペース: 1日あたり{" "}
